...
app.use(cors({
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'X-User-Role', 'X-User-Branch', 'x-user-role', 'x-user-branch', 'x-tai-khoan-id', 'x-ho-so-id', 'X-Tai-Khoan-Id', 'X-Ho-So-Id', 'x-ho-ten', 'X-Ho-Ten', 'x-ho-ten-base64', 'X-Ho-Ten-Base64']
}));
