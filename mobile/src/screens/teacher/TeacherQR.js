...
export default function TeacherQR() {
  ...
  const fetchNewQR = async () => {
    ...
    try {
      ...
      console.error('Lỗi lấy mã QR giáo viên chấm công:', e);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.title}>Mã QR Chấm Công Giáo Viên</Text>
        <Text style={styles.desc}>Sử dụng mã này để chấm công tự động ra/vào lớp dạy</Text>
